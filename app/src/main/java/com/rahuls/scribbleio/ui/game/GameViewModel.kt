...
import com.rahuls.scribbleio.data.GameChatMessage
import com.rahuls.scribbleio.data.RandomWords
import com.rahuls.scribbleio.utils.*
...
class GameViewModel @AssistedInject constructor(
    ...
    private val firebaseDatabase = FirebaseDatabase.getInstance("https://scribbleio-ea1d1-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference(channelClient.groupId)
    ...
    private fun fetchChannelInformation() = viewModelScope.launch {
        ...
        result.onSuccess {
            ...
            if(isHost.value){
                ...
                subscribeToFirebaseDatabase()
            }
        }
    }

    private fun subscribeToFirebaseDatabase() {
    ...
    private fun subscribeToChannelEvent() {
    ...
    interface GameAssistedFactory {
        fun create(channelId: String) : GameViewModel
    }

    companion object{
        @Suppress("UNCHECKED_CAST")
        fun provideGameAssistedFactory(assistedFactory: GameAssistedFactory, channelId: String): ViewModelProvider.NewInstanceFactory {
            return object : ViewModelProvider.NewInstanceFactory() {
                override fun <T : ViewModel> create(modelClass: Class<T>): T {
                    return assistedFactory.create(channelId) as T
                }
            }
        }
    }
