...
class MainViewModel @Inject constructor(
    ...
    val connectedChannel: Flow<Channel?> = _gameConnectionState.filterIsInstance<GameConnectionState.
    Success>().mapNotNull { it.channel }
    ...
    fun createGameGroup(displayName : String, limitUser: Int, limitTime: Int) = viewModelScope.launch {
